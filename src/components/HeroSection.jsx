      ...
      <section id='hero' className='py-36'>
        <div className='flex items-center justify-center flex-col py-20'>
          <div className='text-center'>
            ...
            <a href='/CV-Muzayyin Al-Afnan Siregar.pdf' target="_blank" spy={true} smooth={true} offset={-100} duration={500} className='inline-block px-8 py-3 border border-tranparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:text-md'>See My CV</a>
          </div>
        </div>
      </section>
    </>
